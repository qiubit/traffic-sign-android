...
public class MainActivity extends AbstractCameraXActivity<MainActivity.AnalysisResult> {
  ...
  protected String getModuleAssetName() {
    mModuleAssetName = "valid-98-mobile.pt";
  ...
  protected AnalysisResult analyzeImage(ImageProxy image, int rotationDegrees) {
    ...
    try {
      ...
      runOnUiThread(() -> {
        if (!isFinishing()) {
          showErrorDialog(v -> MainActivity.this.finish());
        }
      });
      return null;
    }
